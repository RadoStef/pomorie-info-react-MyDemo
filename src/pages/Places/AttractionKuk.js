...
const objectName = attractions.slice(0, 1).map(attractionName => attractionName.name);
const objectDescription = attractions.slice(0, 1).map(attractionDesc => attractionDesc.description);
const attractionsXtras = attractions.slice(0, 1);
...
<div className={classes.mapouter}>
    <div className={classes['gmap-canvas']}>
        <iframe className={classes['gmap-iframe']} width="100%" frameborder="0" src="https://maps.google.com/maps?width=800&amp;height=500&amp;hl=en&amp;q=42.553057,27.642097&amp;t=h&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" title='Object Map'></iframe>
    </div>
</div>
