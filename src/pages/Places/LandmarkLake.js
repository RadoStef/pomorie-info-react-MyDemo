...
const objectName = landmarks.slice(1, 2).map(landmarkName => landmarkName.name);
const objectDescription = landmarks.slice(1, 2).map(landmarkDesc => landmarkDesc.description);
const museumsXtras = landmarks.slice(1, 2);
...
<div className={classes.mapouter}>
    <div className={classes['gmap-canvas']}>
        <iframe className={classes['gmap-iframe']} width="100%" frameborder="0" src="https://maps.google.com/maps?width=800&amp;height=500&amp;hl=en&amp;q=42.565442,27.632398&amp;t=h&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" title='Object Map'></iframe>
    </div>
</div>
