...
const objectName = landmarks.slice(2, 3).map(landmarkName => landmarkName.name);
const objectDescription = landmarks.slice(2, 3).map(landmarkDesc => landmarkDesc.description);
const museumsXtras = landmarks.slice(2, 3);
...
<div className={classes.mapouter}>
    <div className={classes['gmap-canvas']}>
        <iframe className={classes['gmap-iframe']} width="100%" frameborder="0" src="https://maps.google.com/maps?width=800&amp;height=500&amp;hl=en&amp;q=42.555081,27.650043&amp;t=h&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" title='Object Map'></iframe>
    </div>
</div>
