...
const objectName = beaches.slice(4, 5).map(beachName => beachName.name);
const objectDescription = beaches.slice(4, 5).map(beachDesc => beachDesc.description);
const beachXtras = beaches.slice(4, 5);
